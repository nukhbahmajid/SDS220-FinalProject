...
ggplot(data = bechdelSampleNEW,  aes(x = binary, fill = director)) +
  geom_bar(position = "dodge") + labs (title = "Comparison of Movies that Pass and Fail the Bechdel Test, \n Split by Director's Gender", x = "Whether or not a Movie Passes the Bechdel Test")
```
